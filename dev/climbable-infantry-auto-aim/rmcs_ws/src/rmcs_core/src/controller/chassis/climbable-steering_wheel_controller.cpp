...
class ClimbableSteeringWheelController
...
public:
    explicit ClimbableSteeringWheelController()
        : Node(
              get_component_name(),
    ...
    void update() override {
        ...
        auto climber_motor_power = calculate_front_climber_motor_power();
        ...
        double power_limit = *power_limit_ - no_load_power_
                           - k2_ * wheel_velocities.array().pow(2).sum() - climber_motor_power;
...
private:
    ...
    double calculate_front_climber_motor_power() {
        double climber_front_left_torque = *climber_front_left_torque_;
        double climber_front_right_torque = *climber_front_right_torque_;
        double climber_front_left_velocity = *climber_front_left_velocity_;
        double climber_front_right_velocity = *climber_front_right_velocity_;
        double left_power = k1_ * climber_front_left_torque * climber_front_left_torque
                          + k2_ * climber_front_left_velocity * climber_front_left_velocity
                          + std::abs(climber_front_left_velocity * climber_front_left_torque);
        double right_power = k1_ * climber_front_right_torque * climber_front_right_torque
                           + k2_ * climber_front_right_velocity * climber_front_right_velocity
                           + std::abs(climber_front_right_velocity * climber_front_right_torque);
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::chassis::ClimbableSteeringWheelController, rmcs_executor::Component)