...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_RMCS_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_RMCS_CONTROLLER_HPP_
...
using ControllerStateMsg     = rmcs_controller::RMCS_Controller::ControllerStateMsg;
using ControllerReferenceMsg = rmcs_controller::RMCS_Controller::ControllerReferenceMsg;
using ControllerModeSrvType  = rmcs_controller::RMCS_Controller::ControllerModeSrvType;
...
class TestableRMCS_Controller : public rmcs_controller::RMCS_Controller {
    FRIEND_TEST(RMCS_ControllerTest, all_parameters_set_configure_success);
    FRIEND_TEST(RMCS_ControllerTest, activate_success);
    FRIEND_TEST(RMCS_ControllerTest, reactivate_success);
    FRIEND_TEST(RMCS_ControllerTest, test_setting_slow_mode_service);
    FRIEND_TEST(RMCS_ControllerTest, test_update_logic_fast);
    FRIEND_TEST(RMCS_ControllerTest, test_update_logic_slow);

public:
    controller_interface::CallbackReturn
        on_configure(const rclcpp_lifecycle::State& previous_state) override {
        auto ret = rmcs_controller::RMCS_Controller::on_configure(previous_state);
...
class RMCS_ControllerFixture : public ::testing::Test {
public:
    ...
    void SetUp() {
        ...
        command_publisher_      = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
            "/test_rmcs_controller/commands", rclcpp::SystemDefaultsQoS());
        ...
        slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
            "/test_rmcs_controller/set_slow_control_mode");
    }
...
protected:
    void SetUpController(const std::string controller_name = "test_rmcs_controller") {
    ...
    void subscribe_and_get_messages(ControllerStateMsg& msg) {
        ...
        auto subscription  = test_subscription_node.create_subscription<ControllerStateMsg>(
            "/test_rmcs_controller/state", 10, subs_callback);
    ...
    std::shared_ptr<ControllerModeSrvType::Response>
        call_service(const bool slow_control, rclcpp::Executor& executor) {
...
protected:
    ...
    std::unique_ptr<TestableRMCS_Controller> controller_;
...
#endif // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_RMCS_CONTROLLER_HPP_
