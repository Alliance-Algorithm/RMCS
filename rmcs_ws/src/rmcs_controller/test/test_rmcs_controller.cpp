...
#include "test_rmcs_controller.hpp"
...
using rmcs_controller::CMD_MY_ITFS;
using rmcs_controller::control_mode_type;
using rmcs_controller::STATE_MY_ITFS;

class RMCS_ControllerTest : public RMCS_ControllerFixture<TestableRMCS_Controller> {};

TEST_F(RMCS_ControllerTest, all_parameters_set_configure_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, check_exported_intefaces) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, activate_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, update_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, deactivate_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, reactivate_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, test_setting_slow_mode_service) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, test_update_logic_fast) {
    SetUpController();
    rclcpp::executors::MultiThreadedExecutor executor;
    executor.add_node(controller_->get_node()->get_node_base_interface());
    executor.add_node(service_caller_node_->get_node_base_interface());
...
TEST_F(RMCS_ControllerTest, test_update_logic_slow) {
    SetUpController();
    rclcpp::executors::MultiThreadedExecutor executor;
    executor.add_node(controller_->get_node()->get_node_base_interface());
    executor.add_node(service_caller_node_->get_node_base_interface());
...
TEST_F(RMCS_ControllerTest, publish_status_success) {
    SetUpController();
...
TEST_F(RMCS_ControllerTest, receive_message_and_publish_updated_status) {
    SetUpController();
    rclcpp::executors::MultiThreadedExecutor executor;
    executor.add_node(controller_->get_node()->get_node_base_interface());
