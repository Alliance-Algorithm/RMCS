...
{
RMCS_Controller::RMCS_Controller() : controller_interface::ControllerInterface() {}
...
controller_interface::CallbackReturn RMCS_Controller::on_configure(
...
controller_interface::InterfaceConfiguration RMCS_Controller::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration RMCS_Controller::state_interface_configuration() const
{
...
controller_interface::CallbackReturn RMCS_Controller::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn RMCS_Controller::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type RMCS_Controller::update(
