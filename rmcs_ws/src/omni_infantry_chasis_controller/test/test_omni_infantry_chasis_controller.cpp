...
#include "test_omni_infantry_chasis_controller.hpp"
...
using omni_infantry_chasis_controller::CMD_MY_ITFS;
using omni_infantry_chasis_controller::control_mode_type;
using omni_infantry_chasis_controller::STATE_MY_ITFS;

class OmniInfantryChasisControllerTest : public OmniInfantryChasisControllerFixture<TestableOmniInfantryChasisController>
{
};

TEST_F(OmniInfantryChasisControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, update_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniInfantryChasisControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniInfantryChasisControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(OmniInfantryChasisControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
