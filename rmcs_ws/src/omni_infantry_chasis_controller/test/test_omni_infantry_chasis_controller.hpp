...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OMNI_INFANTRY_CHASIS_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OMNI_INFANTRY_CHASIS_CONTROLLER_HPP_
...
using ControllerStateMsg = omni_infantry_chasis_controller::OmniInfantryChasisController::ControllerStateMsg;
using ControllerReferenceMsg = omni_infantry_chasis_controller::OmniInfantryChasisController::ControllerReferenceMsg;
using ControllerModeSrvType = omni_infantry_chasis_controller::OmniInfantryChasisController::ControllerModeSrvType;
...
class TestableOmniInfantryChasisController : public omni_infantry_chasis_controller::OmniInfantryChasisController
{
  FRIEND_TEST(OmniInfantryChasisControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(OmniInfantryChasisControllerTest, activate_success);
  FRIEND_TEST(OmniInfantryChasisControllerTest, reactivate_success);
  FRIEND_TEST(OmniInfantryChasisControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(OmniInfantryChasisControllerTest, test_update_logic_fast);
  FRIEND_TEST(OmniInfantryChasisControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = omni_infantry_chasis_controller::OmniInfantryChasisController::on_configure(previous_state);
...
class OmniInfantryChasisControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_omni_infantry_chasis_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_omni_infantry_chasis_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_omni_infantry_chasis_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_omni_infantry_chasis_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableOmniInfantryChasisController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OMNI_INFANTRY_CHASIS_CONTROLLER_HPP_
