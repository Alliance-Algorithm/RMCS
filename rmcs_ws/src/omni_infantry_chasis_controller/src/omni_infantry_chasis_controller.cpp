...
{
OmniInfantryChasisController::OmniInfantryChasisController() : controller_interface::ControllerInterface() {}
...
controller_interface::CallbackReturn OmniInfantryChasisController::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<omni_infantry_chasis_controller::ParamListener>(get_node());
  }
...
controller_interface::CallbackReturn OmniInfantryChasisController::on_configure(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&OmniInfantryChasisController::reference_callback, this, std::placeholders::_1));
...
void OmniInfantryChasisController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
controller_interface::InterfaceConfiguration OmniInfantryChasisController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration OmniInfantryChasisController::state_interface_configuration() const
{
...
controller_interface::CallbackReturn OmniInfantryChasisController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn OmniInfantryChasisController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  omni_infantry_chasis_controller::OmniInfantryChasisController, controller_interface::ControllerInterface)
