...
#ifndef RMCS_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define RMCS_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif // RMCS_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
