...
public:
    ...
    CatapultDartV4(const CatapultDartV4&) = delete;
    CatapultDartV4& operator=(const CatapultDartV4&) = delete;
    CatapultDartV4(CatapultDartV4&&) = delete;
    CatapultDartV4& operator=(CatapultDartV4&&) = delete;

    ~CatapultDartV4() override = default;
...
private:
    ...
    public:
        explicit DartCommand(CatapultDartV4& dart)
            : dart_(dart) {}
        void update() override { dart_.command_update();}

    private:
        CatapultDartV4& dart_;
    };
...
PLUGINLIB_EXPORT_CLASS(rmcs_core::hardware::CatapultDartV4, rmcs_executor::Component)
