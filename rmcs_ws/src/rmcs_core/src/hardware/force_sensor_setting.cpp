...
private:
    ...
    public:
        explicit RoboCommand(ForceSensorSetting& robot)
            : robot_(robot) {}
...
PLUGINLIB_EXPORT_CLASS(rmcs_core::hardware::ForceSensorSetting, rmcs_executor::Component)