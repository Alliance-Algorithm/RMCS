...
public:
    CatapultDartCBoard()
        ...
        , command_component_(
              create_partner_component<CatapultDartCBoardCommand>(
    ...
    CatapultDartCBoard(const CatapultDartCBoard&) = delete;
    CatapultDartCBoard& operator=(const CatapultDartCBoard&) = delete;
    CatapultDartCBoard(CatapultDartCBoard&&) = delete;
    CatapultDartCBoard& operator=(CatapultDartCBoard&&) = delete;

    ~CatapultDartCBoard() override = default;
...
private:
    class CatapultDartCBoardCommand : public rmcs_executor::Component {
    public:
        explicit CatapultDartCBoardCommand(CatapultDartCBoard& hero)
            : hero_(hero) {}

        void update() override { hero_.command_update(); }

        CatapultDartCBoard& hero_;
    };
    std::shared_ptr<CatapultDartCBoardCommand> command_component_;

    struct DartBoard final : librmcs::board::CBoard::Callback {
        explicit DartBoard(
            CatapultDartCBoard& catapult_dart, CatapultDartCBoardCommand& catapult_dart_command,
...
PLUGINLIB_EXPORT_CLASS(rmcs_core::hardware::CatapultDartCBoard, rmcs_executor::Component)
