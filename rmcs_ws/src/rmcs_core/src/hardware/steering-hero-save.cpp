...
//             hero.register_output("/auto_aim/image_capturer/timestamp", camera_capturer_trigger_timestamp_,
//             0); hero.register_output("/auto_aim/image_capturer/trigger", camera_capturer_trigger_, 0);
//         }
...
//                 0x141,
//                 gimbal_bullet_feeder_.generate_torque_command(gimbal_bullet_feeder_.control_torque()));
