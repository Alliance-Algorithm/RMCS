...
//             librmcs::spec::c_board::kGpioDescriptors[1],
...
//                 RCLCPP_INFO(
//                     logger_, "[CAN2 unknown] id=0x%03X raw(%zu): %s", can_id,
//                     data.can_data.size(), bytes_to_hex_string(data.can_data.data(),
//                     data.can_data.size()).c_str());
//             }
//         }
...
//     void accelerometer_receive_callback(const librmcs::data::AccelerometerDataView& data)
//     override {
