...
public:
    ...
    void update_status() {
        ...
        *joystick_right_ = to_eigen_vector(joystick_right());
        *joystick_left_  = to_eigen_vector(joystick_left());

        *switch_right_ = std::bit_cast<rmcs_msgs::Switch>(switch_right());
        *switch_left_  = std::bit_cast<rmcs_msgs::Switch>(switch_left());

        *mouse_velocity_ = to_eigen_vector(mouse_velocity());

        *mouse_    = std::bit_cast<rmcs_msgs::Mouse>(mouse());
        *keyboard_ = std::bit_cast<rmcs_msgs::Keyboard>(keyboard());
    }
...
//         component.register_output(
//             "/remote/joystick/right", joystick_right_, Eigen::Vector2d::Zero());
//         component.register_output("/remote/joystick/left", joystick_left_,
//         Eigen::Vector2d::Zero());

//         component.register_output(
//             "/remote/switch/right", switch_right_, rmcs_msgs::Switch::UNKNOWN);
//         component.register_output("/remote/switch/left", switch_left_,
//         rmcs_msgs::Switch::UNKNOWN);
