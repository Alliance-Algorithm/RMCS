...
class LiftingLeft {
public:
    LiftingLeft(rmcs_executor::Component& command_component, const std::string& name) {
...
private:
    ...
    uint8_t read_angle_command_[8] = {0xFF, 0xFF, 0x03, 0x04, 0x02, 0x38, 0x02, 0xBC};

    uint8_t switch_servo_mode_[8] = {0xFF, 0xFF, 0x03, 0x04, 0x03, 0x1C, 0x01, 0xD8};
    uint8_t switch_motor_mode_[8] = {0xFF, 0xFF, 0x03, 0x04, 0x03, 0x1C, 0x00, 0xD9};

    uint8_t switch_motor_forward_mode_[8] = {0xFF, 0xFF, 0x03, 0x04, 0x03, 0x1D, 0x00, 0xD8};
    uint8_t switch_motor_reverse_mode_[8] = {0xFF, 0xFF, 0x03, 0x04, 0x03, 0x1D, 0x01, 0xD7};

    uint8_t motor_mode_runtime_control_[9] = {0xFF, 0xFF, 0x03, 0x05, 0x03, 0x41, 0x00, 0x14, 0x9F};
    uint8_t motor_mode_disable_control_[9] = {0xFF, 0xFF, 0x03, 0x05, 0x03, 0x41, 0x00, 0x00, 0xB3};
