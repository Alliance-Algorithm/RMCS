...
private:
    ...
    class TopBoard final : public librmcs::board::RmcsBoardLite::Callback {
    public:
        ...
        void command_update() {
            ...
            if (std::isfinite(gimbal_pitch_motor_.control_angle()))
                builder.can_transmit(Spec::kCans.kCan0, {
                    .can_id = 0x142,
            ...
            builder.can_transmit(Spec::kCans.kCan3, {
                .can_id = 0x142,
    ...
    class BottomBoard final : public librmcs::board::RmcsBoardLite::Callback {
    public:
        friend class SteeringHeroLittle;
...
//         remote_control_ =
//             std::make_unique<device::RemoteControl>(*this, bottom_board_->dr16_,
//             top_board_->vt13_);
...
//                   {steering_hero, steering_hero_command, "/gimbal/second_right_friction"},
//                   {steering_hero, steering_hero_command, "/gimbal/second_left_friction"})
//             , gimbal_bullet_feeder_(steering_hero, steering_hero_command,
//             "/gimbal/bullet_feeder") , putter_motor_(steering_hero, steering_hero_command,
//             "/gimbal/putter") , gimbal_scope_motor_(steering_hero, steering_hero_command,
//             "/gimbal/scope") , gimbal_player_viewer_motor_(
//                   steering_hero, steering_hero_command, "/gimbal/player_viewer") {
...
//             steering_hero.register_output("/gimbal/yaw/velocity_imu", gimbal_yaw_velocity_imu_);
//             steering_hero.register_output("/gimbal/pitch/velocity_imu",
...
//             , gimbal_bottom_yaw_motor_(steering_hero, steering_hero_command,
//             "/gimbal/bottom_yaw") {
//             //
//             chassis_steering_motors_[0].configure(
//                 device::DjiMotor::Config{device::DjiMotor::Type::kGM6020}
...
//             *chassis_yaw_velocity_imu_ = imu_.gz();
//             *chassis_pitch_imu_ = -std::asin(2.0 * (imu_.q0() * imu_.q2() - imu_.q3() *
//             imu_.q1()));
