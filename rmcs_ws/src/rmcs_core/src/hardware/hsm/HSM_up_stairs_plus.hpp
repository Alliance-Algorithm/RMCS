...
enum class StepSubState { Wait, Press, Lift, PressAndLift, PressAgain };
...
const UpStairsEvent go_to_Press_Again{UpStairsEventId{UpStairsEventEnum::go_to_Press_Again}, {}};
...
public:
    ...
    Auto_Leg_Up_Stairs& init_and_trajectory_set(
        ...
        bind("initial", up_stairs_initial)
            ...
            .bind("press_again", up_stairs_leg_press_again);
        ...
        up_stairs_leg_press_again.set_end_point(
            {press_again_end_point_[0], press_again_end_point_[1], press_again_end_point_[2],
             press_again_end_point_[3], 0, 0});
        ...
        stepByTwo->addSubState(createPressAgainState());
...
private:
                ...
                return std::visit(
                    [&](auto&& id) -> std::optional<StepSubState> {
                        if constexpr (std::is_same_v<decltype(id), UpStairsEventEnum>) {
                            ...
                            } else if (id == UpStairsEventEnum::go_to_Press_Again) {
    ...
    std::unique_ptr<IState<StepSubState, UpStairsEventId, UpStairsContext>>
        ...
        return std::make_unique<BasicState<StepSubState, UpStairsEventId, UpStairsContext>>(
            ...
            [&](UpStairsContext& ctx, const EventArgs&) {
                auto& traj = ctx.getTrajectory("press_again");
                traj.reset();
                traj.set_start_point(
                    {**ctx.getInputD("theta_lf"), **ctx.getInputD("theta_lb"),
                     **ctx.getInputD("theta_rb"), **ctx.getInputD("theta_rf"), 0.0, 0.0});
