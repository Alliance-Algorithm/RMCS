...
//         first_sample_taken_ = false;
//         final_sample_taken_ = false;
...
//             if (elapsed_seconds >= final_sample_spot_ && !final_sample_taken_) {
//                 double yaw_at_first_sample = filtered_yaw;
//                 double yaw_at_final_sample = filtered_yaw;
//                 double final_sample_time = elapsed_seconds;
//                 final_sample_taken_ = true;
                
//                 double time_diff = final_sample_time - first_sample_spot_;
//                 double yaw_diff = yaw_at_final_sample - yaw_at_first_sample;
...
//         if (calibration_complete_) {
//             double time_since_calibration = elapsed_seconds - first_sample_spot_;
...
//     bool first_sample_taken_ = false;
