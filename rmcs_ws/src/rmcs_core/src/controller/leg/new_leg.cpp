...
// #include "hardware/hsm/HSM_up_stairs_plus.hpp"
...
//                 press_again_end_point_)
//             .bind("speed", chassis_velocity_)
//             .bind("theta_lf", theta_lf)
//             .bind("theta_lb", theta_lb)
//             .bind("theta_rb", theta_rb)
//             .bind("theta_rf", theta_rf)
//             .bind("result", result);
...
//         if (keyboard_->ctrl) {
//             up_stairs.processEvent(
//                 rmcs_core::hardware::hsm::up_stairs_hsm::events::go_to_Press_Again);
//         }
