...
//         //      0});
// up_stairs_leg_press.set_end_point({0.406814,0.395241,0.395241,0.406814,0,0});
...
// private:
//     void mode_selection() {
//         // RCLCPP_INFO(this->get_logger(), "lift start");
//         auto switch_right = *switch_right_;
//         auto switch_left  = *switch_left_;
//         auto mouse        = *mouse_;
//         auto keyboard     = *keyboard_;
...
//                 one_step_mode = StepMode::Wait;
//                 two_step_mode = StepMode::Wait;
//             }
//             if (keyboard.d) {
//                 leg_mode = rmcs_msgs::LegMode::Four_Wheel;
//             }
...
//         auto enter_state = [&](StepMode& mode, StepMode next) {
//             if (mode != next) {
//                 mode = next;
//                 // RCLCPP_INFO(this->get_logger(), "State Changed to: %s", next);
//                 return true;
//             }
//             return false;
//         };
...
//         } else {
//             switch (up_stairs_mode) {
//             case rmcs_msgs::UpStairsMode::Step_By_One: {
//                 switch (one_step_mode) {
//                 case StepMode::Wait: {
//                     if (keyboard.z) {
//                         if (enter_state(one_step_mode, StepMode::Press_And_Lift)) {
//                             up_stairs_leg_press_and_lift.reset();
//                             RCLCPP_INFO(this->get_logger(), "press reset");
//                             up_stairs_leg_press_and_lift.set_start_point(
//                                 {*theta_lf, *theta_lb, *theta_rb, *theta_rf, 0.0, 0.0});
//                             up_stairs_leg_press_and_lift.set_total_step(
//                                 calculate_steps(k_[2], b_[2]));
//                         }
//                     }
//                     break;
//                 }
//                 case StepMode::Press_And_Lift: {
//                     if (!up_stairs_leg_press_and_lift.get_complete())
//                         result = up_stairs_leg_press_and_lift.trajectory();
//                     else {
//                         result[0]     = 0.8;
//                         result[3]     = 0.8;
//                         one_step_mode = StepMode::Wait;
...
//             case rmcs_msgs::UpStairsMode::Step_By_Two: {
//                 // RCLCPP_INFO(this->get_logger(), "setp tow");
//                 switch (two_step_mode) {
//                     //   RCLCPP_INFO(this->get_logger(), "adad");

//                 case StepMode::Wait: {
//                     // RCLCPP_INFO(this->get_logger(), "setp tow");
//                     if (keyboard.shift) {
//                         if (enter_state(two_step_mode, StepMode::Press)) {
//                             up_stairs_leg_press.reset();
//                             RCLCPP_INFO(this->get_logger(), "press reset");
//                             up_stairs_leg_press.set_start_point(
//                                 {*theta_lf, *theta_lb, *theta_rb, *theta_rf, 0.0, 0.0});
//                             // up_stairs_leg_press.set_total_step(calculate_steps(k_[0], b_[0]));
//                             up_stairs_leg_press.set_total_step(1000);
//                         }
//                     } else if (keyboard.a) {
//                         RCLCPP_INFO(this->get_logger(), "lift keyboard press");
//                         if (enter_state(two_step_mode, StepMode::Lift)) {
//                             RCLCPP_INFO(this->get_logger(), "lift start");
//                             up_stairs_leg_lift.reset();
//                             up_stairs_leg_lift.set_start_point(
//                                 {*theta_lf, *theta_lb, *theta_rb, *theta_rf, 0.0, 0.0});
//                             up_stairs_leg_lift.set_total_step(1000);
//                             // up_stairs_leg_press.set_total_step(calculate_steps(k_[1], b_[1]));
//                         }
//                     }

//                     else if(keyboard.c){
//                          RCLCPP_INFO(this->get_logger(), "press again keyboard press");
//                         if (enter_state(two_step_mode, StepMode::Press_Again)) {
//                             up_stairs_leg_press_again.reset();
//                             RCLCPP_INFO(this->get_logger(), "press again reset");
//                             up_stairs_leg_press_again.set_start_point(
//                                 {*theta_lf, *theta_lb, *theta_rb, *theta_rf, 0.0, 0.0});
//                             up_stairs_leg_press_again.set_total_step(1000);
//                         }
//                     }
//                     break;
//                 }
...
//                         // RCLCPP_INFO(this->get_logger(), "press process");
//                     } else {
//                         RCLCPP_INFO(this->get_logger(), "press complete");
//                         two_step_mode = StepMode::Wait;
//                     }
//                     break;
//                 }
...
//                     break;
//                 }
//                 case StepMode::Press_Again:{
//                     if(!up_stairs_leg_press_again.get_complete()) {
//                         result = up_stairs_leg_press_again.trajectory();
//                     } else {
//                         two_step_mode = StepMode::Wait;
//                     }
//                     break;
...
//         double raw = static_cast<double>(k) * ((*chassis_velocity_)->x() - v_reference)
//                    + static_cast<double>(b);

//         return static_cast<int>(raw);
//     }

//     enum class StepMode : uint8_t { Press, Lift, Press_And_Lift, Wait ,Press_Again};
//     StepMode one_step_mode = StepMode::Wait;
//     StepMode two_step_mode = StepMode::Wait;
...
//     hardware::device::Trajectory<hardware::device::TrajectoryType::JOINT> up_stairs_leg_press_again;
