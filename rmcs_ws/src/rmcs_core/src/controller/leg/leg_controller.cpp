    ...
    LegController()
               ...
               {"initial", "press", "lift", "lift_and_initial", "press_again", "lift_again"}}}
        {
            ...
            six_wheel_trajectory
                .set_end_point(
                    std::vector<double>{
                        six_wheel_angle[0], six_wheel_angle[1], six_wheel_angle[1],
                        six_wheel_angle[0]})
                .set_total_step(500);
    ...
    private:
        ...
        void leg_control() {
            ...
            case rmcs_msgs::LegMode::Four_Wheel:
                execute_joint_trajectory(four_wheel_trajectory);
                break;
        ...
        void execute_joint_trajectory(
            rmcs_core::controller::arm::Trajectory<
                rmcs_core::controller::arm::TrajectoryType::JOINT>
            & trajectory) {
