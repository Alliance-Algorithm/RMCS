...
class ThreeFrictionWheelController
    : public rmcs_executor::Component
    , public rclcpp::Node {
public:
    ThreeFrictionWheelController()
        : Node(
              get_component_name(),
    ...
    void update() override {
        ...
        // Do not leave the velocity PID closing a zero-speed loop when the wheels are disabled.
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::shooting::ThreeFrictionWheelController, rmcs_executor::Component)
