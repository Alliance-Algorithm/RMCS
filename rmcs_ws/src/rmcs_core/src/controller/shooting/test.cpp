...
//         register_input("/gimbal/putter/torque", putter_torque_);
...
//         bullet_feeder_angle_pid_.kp = 15.0;
//         bullet_feeder_angle_pid_.ki = 0.0;
//         bullet_feeder_angle_pid_.kd = 3.0;
...
//             } else if (bullet_feeder_cool_down_ > 0 || shoot_stage_ == ShootStage::RESETTING) {
...
//                         }
//                         double velocity_err =
//                             bullet_feeder_angle_pid_.update(angle_err) -
//                             *bullet_feeder_velocity_;
//                         *bullet_feeder_control_torque_ =
//                             bullet_feeder_velocity_pid_.update(velocity_err);
...
//         bullet_feeder_reset_count_ = 0;

//         putter_faulty_count_ = 0;
//         putter_reset_count_ = 0;
...
//     void update_putter_reset() {
//         if (*putter_torque_ < -0.02) {
//             ++putter_reset_count_;
//         } else {
//             putter_reset_count_ = 0;
//             return;
...
//         if (putter_reset_count_ >= 500) {
//             putter_reset_count_ = 0;
//             RCLCPP_INFO(get_logger(), "Putter_controller timeout, reset...");
//             shooted = false;
//             set_preloading();
//         }
//     }

//     void update_reset_detection() {
//         if (std::abs(*bullet_feeder_control_torque_) > 50) {
//             ++bullet_feeder_reset_count_;
//         } else {
//             bullet_feeder_reset_count_ = 0;
//             return;
//         }

//         if (bullet_feeder_reset_count_ >= 800) {
//             bullet_feeder_reset_count_ = 0;
//             RCLCPP_INFO(get_logger(), "Resetting timeout, reset...");
//             reset_all_controls();
//         }
//     }
...
//         }
//         bullet_feeder_control_angle_ = reference_angle + (pi / 3);
//     }
...
//     InputInterface<double> putter_torque_;
...
//     int bullet_feeder_reset_count_ = 0;
