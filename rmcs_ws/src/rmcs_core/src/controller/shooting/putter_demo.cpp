...
//         bullet_feeder_velocity_pid_.kp = 30.0;
//         bullet_feeder_velocity_pid_.ki = 5.0;
//         bullet_feeder_velocity_pid_.kd = 0.0;
//         bullet_feeder_velocity_pid_.integral_max = 40.0;
...
//         } else {
//             // 推杆未初始化：执行复位操作
//             *putter_control_torque_ = puttter_return_velocity_pid_.update(-80. -
...
//         if (*bullet_feeder_velocity_ < 2.0 && *bullet_feeder_control_torque_ > 0.8) {
//             bullet_feeder_locked_count_++;
//         } else {
//             bullet_feeder_locked_count_ = 0;
//         }

//         if (bullet_feeder_locked_count_ > 800) {
//             bullet_feeder_locked_count_ = 0;
//             if (*photoelectric_sensor_status_)
//                 set_preloaded(); // 进入预装弹状态，等待光电门触发
...
//     void enter_reverse_start() {
//         bullet_feeder_control_angle_ = nan_;
//         bullet_feeder_reverse_end_ = 1000;
//         bullet_feeder_angle_pid_.reset();
//         bullet_feeder_velocity_pid_.reset();
//         RCLCPP_INFO(get_logger(), "Reverse start!");
//     }
...
//     int bullet_feeder_locked_count_ = 0;
