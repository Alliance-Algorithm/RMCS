...
//         register_input("/gimbal/bullet_feeder/velocity", bullet_feeder_velocity);
...
//                         *bullet_feeder_angle_; if (abs(angle_err) < 0.1) {
//                             set_compressed();
//                         }
//                         double velocity_err =
...
//                     } else if (
//                         shoot_stage_ == ShootStage::SHOOTING || shoot_stage_ ==
//                         ShootStage::UPDATING
...
//                     // 发射状态：检测子弹是否发出
//                     if (*bullet_fired_ || *putter_angle_ - putter_startpoint >= putter_stroke_) {
//                         shooted = true;
//                     }
...
//     shoot_stage_ = ShootStage::PRELOADIND;
