...
class HeroSteeringWheelController
...
public:
    explicit HeroSteeringWheelController()
        : Node(
              get_component_name(),
        ...
        register_output(
            "/chassis/steering_wheel/actual_power_estimate", steering_wheel_actual_power_estimate_,
            0.0);
    }
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::chassis::HeroSteeringWheelController, rmcs_executor::Component)
