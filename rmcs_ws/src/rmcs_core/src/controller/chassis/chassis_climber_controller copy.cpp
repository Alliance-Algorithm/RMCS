...
//         RCLCPP_INFO_THROTTLE(
//             logger_, *get_clock(), 500, "ALIGN: err=%.3f, yaw_velocity=%.3f, stable_ticks=%d",
//             err, yaw_velocity, auto_climb_align_stable_count_);
...
//                 stop_auto_climb();
//                 RCLCPP_INFO(logger_, "Auto climb completed (finished %d steps).",
//                 finished_steps);
//             }
//         }
...
//                 && std::abs(*climber_back_right_velocity_) <
//                 kBackClimberBlockedVelocityThreshold);
//     }
