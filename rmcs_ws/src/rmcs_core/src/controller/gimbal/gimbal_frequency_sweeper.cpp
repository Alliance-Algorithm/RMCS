...
class GimbalFrequencySweeper
    : public rmcs_executor::Component
    , public rclcpp::Node {
public:
    GimbalFrequencySweeper()
        : Node("gimbal_frequency_sweeper") {
        // 创建数据存储目录
        ...
        register_output("/gimbal/yaw/control_current", yaw_control_torque_);
...
private:
    ...
    static constexpr double Top      = 3.0;
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::gimbal::GimbalFrequencySweeper, rmcs_executor::Component)