...
public:
    ShootingController()
        ...
        register_input("/gimbal/left_friction/velocity", left_friction_velocity_, false);
        register_input("/gimbal/right_friction/velocity", right_friction_velocity_, false);
        ...
        register_input("/gimbal/bullet_feeder/velocity", bullet_feeder_velocity_, false);

        register_input("/gimbal/shooting/fire_controller_", fire_controller_, false);
        register_output("/gimbal/left_friction/control_velocity", left_friction_control_velocity_, nan);
        register_output("/gimbal/right_friction/control_velocity", right_friction_control_velocity_, nan);
        register_output("/gimbal/bullet_feeder/control_velocity", bullet_feeder_control_velocity_, nan);
    ...
    void update() override {
        ...
        if ((switch_left == Switch::UNKNOWN || switch_right == Switch::UNKNOWN)
            ...
            if (switch_right != Switch::DOWN) {
                ...
                bullet_feeder_enabled_ = (switch_right == Switch::UP && *fire_controller_) || mouse.left
...
private:
    ...
    void update_muzzle_heat() {
        ...
        bullet_count_limited_by_shooter_heat_ = (20'000'000 - shooter_heat_ - 10'000) / 10'000;
    ...
    void update_bullet_feeder_velocity() {
        if (!friction_enabled_ || !bullet_feeder_enabled_ || bullet_count_limited_by_shooter_heat_ == 0) {
