...
public:
    ShootingController()
        ...
        bullet_feeder_deep_eject_velocity_ =
            -(2 * std::numbers::pi / bullets_per_feeder_turn) * deep_eject_frequency;
