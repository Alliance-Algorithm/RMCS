...
class ClimbableInfantryGimbalController
    : public rmcs_executor::Component
    , public rclcpp::Node {
public:
    ClimbableInfantryGimbalController()
        : Node(
              get_component_name(),
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::gimbal::ClimbableInfantryGimbalController, rmcs_executor::Component)