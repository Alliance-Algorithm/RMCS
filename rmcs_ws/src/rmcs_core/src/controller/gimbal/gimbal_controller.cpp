...
public:
    GimbalController()
        ...
        auto_control_angle_sub_ = create_subscription<geometry_msgs::msg::Pose2D>(
            "/sentry/control/angle", 10, [this](const geometry_msgs::msg::Pose2D::UniquePtr& msg) {
        ...
        gettimeofday(&time_tick_, nullptr);
        time_zero_ = (double)time_tick_.tv_sec * 1e6 + (double)time_tick_.tv_usec;
