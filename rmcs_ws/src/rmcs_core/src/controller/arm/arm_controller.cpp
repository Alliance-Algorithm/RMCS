...
public:
    ArmController()
        ...
        register_input("/sub/arm/board/can_received", sub_board_can_received_);
        register_input("/sub/arm/board/missing", sub_armboard_missing_);
        // move_group_ =
        //     std::make_unique<moveit::planning_interface::MoveGroupInterface>(node_,
        //     "alliance_arm");
    ...
    void update() override {
        if (startup_disable_count_ <= kStartupDisableCycles) {
