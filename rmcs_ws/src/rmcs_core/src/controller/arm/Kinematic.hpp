...
public:
    ...
    static std::array<double, 6> arm_inverse_kinematic(std::array<double, 6> xyz_rpy) {
        ...
        theta2_1        = rmcs_utility::normalize_angle(theta2_1);
        theta2_2        = rmcs_utility::normalize_angle(theta2_2);
        // RCLCPP_INFO(
        ...
        theta3_1_1 = rmcs_utility::normalize_angle(theta3_1_1);
        theta3_1_2 = rmcs_utility::normalize_angle(theta3_1_2);
        theta3_2_1 = rmcs_utility::normalize_angle(theta3_2_1);
        theta3_2_2 = rmcs_utility::normalize_angle(theta3_2_2);
        ...
        theta5 = rmcs_utility::normalize_angle(theta5) + std::numbers::pi / 2.0;
        theta4 = rmcs_utility::normalize_angle(theta4);
        theta6 = rmcs_utility::normalize_angle(theta6);
